...
/**
 * An ImageFile, extended from MediaXFile, file is any File that can fit through
 * ImageFileFilter
 * 
 * @see ImageFileFilter
 * @see MediaXFile
 ...
 * 
 */
public class ImageFile extends MediaXFile {
	...
	private void setGPS(final double longitude, final double latitude)
